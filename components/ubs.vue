<template lang="pug">
  ...
  .message-wrapper#message-wrapper(ref="santaMessageBox")
    ...
    .responses(v-if="santaActions === 4")
      button.response(@click="$emit('handleAction', 'santa7', 'Mach weiter, Nikolaus!', ['santa8', 'santa11','santa12','santa13','santa14','santa15','santa16','santa17','santa18','santa19','santa20','santa21'], [4000, 16000, 18000, 20000, 26000, 38000, 52000, 64000, 77000, 82000, 97000, 101000], 5)") Mach weiter, Nikolaus!
      button.response(@click="$emit('handleAction','santa7b', 'Stop! Sami, schliess das Buch!', ['santa8', 'santa11','santa12','santa13','santa14','santa15','santa16','santa17','santa18','santa19','santa20','santa21'], [4000, 16000, 18000, 20000, 26000, 38000, 52000, 64000, 77000, 82000, 97000, 101000], 5)") Stop! Sami, schliess das Buch!
    ...
    .responses(v-if="santaActions === 6")
      button.response(@click="$emit('handleAction','santa24', 'Lies weiter, Samichlaus!',['santa25','santa26','santa27','santa28','santa29', 'santa30'],[9000,14000,19000,21000,30050, 33000], 7)") Lies weiter, Samichlaus!
